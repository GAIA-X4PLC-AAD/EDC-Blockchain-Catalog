...
public class BlockchainAssetCreator implements EventSubscriber {
    ...
    public BlockchainAssetCreator(Monitor monitor, AssetIndex assetIndex, String edcInterfaceUrl, String providerUrl, AssetApiController assetApiController, JsonLd jsonLd, BlockchainSmartContractService blockchainSmartContractService) {
